...
class BertEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.position_enc = nn.Embedding(config.max_position_embeddings, config.hidden_size)
        # embedding矩阵初始化
        # nn.init.orthogonal_(self.word_embeddings.weight)
        # nn.init.orthogonal_(self.token_type_embeddings.weight)
        # nn.init.orthogonal_(self.position_enc.weight)
        ...
        # self.position_enc.weight.data = \
        #     self.position_enc.weight.data.div(
        #         torch.norm(self.position_enc.weight, p=2, dim=1, keepdim=True).data + epsilon)
    ...
    def forward(self, input_ids, position_ids, token_type_ids=None):
        ...
        :param position_ids: 位置id [batch_size, sequence_length]
        ...
        positional_enc = self.position_enc(position_ids)
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(self, input_ids, positional_enc, token_type_ids=None, attention_mask=None,
        ...
        # print("positional_enc: ", positional_enc.shape)
